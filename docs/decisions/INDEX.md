...
| [0003-two-layer-checks.md](0003-two-layer-checks.md) | Why two-layer check architecture — deterministic (pure Python) + AI-assisted (MCP) |
| [0004-byok-mcp.md](0004-byok-mcp.md) | Why BYOK via MCP — user brings their own AI, tool doesn't care which one |
