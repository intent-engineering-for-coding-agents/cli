...
| [testing-convention.md](testing-convention.md) | Generic Intent Engineering testing conventions — test layers, AC IDs, traceability markers, proof requirements |
| [testing-strategy.md](testing-strategy.md) | iec-cli project instantiation of the testing convention |
