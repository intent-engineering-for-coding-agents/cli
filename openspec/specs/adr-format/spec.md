...
Validates that each ADR file in `docs/decisions/` conforms to the MADR (Markdown Architectural Decision Records) format: correct filename convention, required title heading, required sections, and a valid status field.
