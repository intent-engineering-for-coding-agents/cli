...
The registry discovers, registers, and executes checker plugins. Each checker has a unique ID, a description, and a `check` method that inspects a repo path and returns a structured result.
