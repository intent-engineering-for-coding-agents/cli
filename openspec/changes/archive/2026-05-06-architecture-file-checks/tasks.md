...
- [x] 1.1 Create `src/iec_cli/checkers/docs_readme_exists.py` with checker that walks `docs/` recursively, checks every subdirectory for `README.md`
...
- [x] 2.1 Create `src/iec_cli/checkers/docs_index_exists.py` with checker that walks `docs/` recursively, checks every subdirectory for `INDEX.md`
...
- [x] 3.1 Create `src/iec_cli/checkers/docs_index_stale.py` with checker that walks `docs/`, finds every `INDEX.md`, parses links, cross-references against directory contents
...
- [x] 4.1 Update `src/iec_cli/checkers/__init__.py` to import new checker modules
- [x] 4.2 Integration test: `iec check` runs all six checkers against iec-cli's own repo
